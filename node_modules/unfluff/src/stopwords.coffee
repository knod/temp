...
getFilePath = (language) ->
  ...
  # path.join( "..", "data", "stopwords", "stopwords-#{language}.json")
  path.join( 'node_modules', 'unfluff', 'data', 'stopwords', 'stopwords-' + language + '.json' )
...
module.exports = stopwords = (content, language = 'en') ->
  ...
  # language + '_stopwords' may be more clear
